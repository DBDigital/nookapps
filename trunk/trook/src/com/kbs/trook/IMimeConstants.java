...
{
    public final static String MIME_APK = "application/vnd.android.package-archive";
    ...
    public final static String MIME_EPUB = "application/epub";
    public final static String MIME_PDF = "application/pdf";
    public final static String MIME_PDB = "application/pdb";
}